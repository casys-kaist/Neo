...
CUDA_VISIBLE_DEVICES=$CUDA_VISIBLE_DEVICES \
    ...
    --frame_step 1 \
    --output_path $OUTPUT_PATH/periodic_sorting/$SCENE/$RESOLUTION \
    --reuse_mode \
    --trace_mode \
    --image_mode
...
CUDA_VISIBLE_DEVICES=$CUDA_VISIBLE_DEVICES \
    ...
    --yaml_path $OUTPUT_PATH/periodic_sorting/$SCENE/$RESOLUTION/trace.yaml \
    --output_path $OUTPUT_PATH \
    --device periodic_sorting \
    --resolution $RESOLUTION \
    --scene $SCENE \
    --iteration $ITERATION \
    --algorithm periodic_sorting \
    --figure_idx 19
...
for ((i = 1; i < $ITERATION; i++)); do
    ...
    CUDA_VISIBLE_DEVICES=$CUDA_VISIBLE_DEVICES \
        ...
        --trace_path $OUTPUT_PATH/periodic_sorting/$SCENE/$RESOLUTION/trace/$i \
        --chunk_size 256 \
        --tile_size 64 \
        --output_path $OUTPUT_PATH/periodic_sorting/$SCENE/$RESOLUTION/trace/$i

    cd $OUTPUT_PATH/periodic_sorting/$SCENE/$RESOLUTION/trace/$i
