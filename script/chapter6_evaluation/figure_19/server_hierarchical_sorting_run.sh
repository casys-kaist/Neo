...
CUDA_VISIBLE_DEVICES=$CUDA_VISIBLE_DEVICES \
    ...
    --frame_step 1 \
    --output_path $OUTPUT_PATH/neo_hs/$SCENE/$RESOLUTION \
    --reuse_mode \
    --trace_mode \
    --image_mode
...
CUDA_VISIBLE_DEVICES=$CUDA_VISIBLE_DEVICES \
    ...
    --yaml_path $OUTPUT_PATH/neo_hs/$SCENE/$RESOLUTION/trace.yaml \
...
for ((i = 1; i < $ITERATION; i++)); do
    ...
    CUDA_VISIBLE_DEVICES=$CUDA_VISIBLE_DEVICES \
        ...
        --trace_path $OUTPUT_PATH/neo_hs/$SCENE/$RESOLUTION/trace/$i \
        --chunk_size 256 \
        --tile_size 64 \
        --output_path $OUTPUT_PATH/neo_hs/$SCENE/$RESOLUTION/trace/$i

    cd $OUTPUT_PATH/neo_hs/$SCENE/$RESOLUTION/trace/$i
    ln -s $SIMULATOR_PATH/neo_hs/build/sim ./sim
