...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--scene", type=str, default="", help="Scene name for the workload"
    )
    parser.add_argument(
        "--resolution", type=str, default="", help="Resolution for the workload"
    )
    parser.add_argument(
        "--iteration", type=int, default=10, help="Number of iterations to run"
    )
    ...
    neo_ae.postprocess(figure_idx=args.figure_idx)
