...
src_dir = Path("src") / "periodic_sorting_trace_backend"
third_party_glm_dir = pwd / src_dir / "third_party" / "glm"

setup(
    name="periodic_sorting_trace_backend",
    packages=["periodic_sorting_trace_backend"],
    package_dir={"": "src"},
    ext_modules=[
        CUDAExtension(
            name="periodic_sorting_trace_backend._C",
            sources=[
