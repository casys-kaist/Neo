...
from ..utils.camera_utils import get_resolution
...
def readColmapCameras(
    ...
    selected_cam_infos = [sorted_cam_infos[idx] for idx in range(get_num_images())]

    sys.stdout.write("\n")
    return selected_cam_infos
...
def readCamerasFromTransforms(
    ...
    with open(os.path.join(path, transformsfile)) as json_file:
        ...
        for idx, frame in enumerate(frames):
            ...
            image = Image.new("RGB", get_resolution(), (255, 255, 255))
